...
select results_eq(
  ...
  $$values
      ('acceptance_responses'::text collate "C", 'service_role'::text collate "C", 'DELETE'::text collate "C"),
      ('acceptance_responses', 'service_role', 'INSERT'),
      ('acceptance_responses', 'service_role', 'SELECT'),
      ('acceptance_responses', 'service_role', 'UPDATE'),
      ('blocks', 'service_role', 'DELETE'),
      ('blocks', 'service_role', 'INSERT'),
      ('blocks', 'service_role', 'SELECT'),
      ('blocks', 'service_role', 'UPDATE'),
      ('card_decisions', 'service_role', 'DELETE'),
      ('card_decisions', 'service_role', 'INSERT'),
      ('card_decisions', 'service_role', 'SELECT'),
      ('card_decisions', 'service_role', 'UPDATE'),
      ('contact_blocks', 'service_role', 'DELETE'),
      ('contact_blocks', 'service_role', 'INSERT'),
      ('contact_blocks', 'service_role', 'SELECT'),
      ('contact_blocks', 'service_role', 'UPDATE'),
      ('daily_cards', 'service_role', 'DELETE'),
      ('daily_cards', 'service_role', 'INSERT'),
      ('daily_cards', 'service_role', 'SELECT'),
      ('daily_cards', 'service_role', 'UPDATE'),
      ...
      ('match_participants', 'authenticated', 'SELECT'),
      ('match_participants', 'service_role', 'DELETE'),
      ('match_participants', 'service_role', 'INSERT'),
      ('match_participants', 'service_role', 'SELECT'),
      ('match_participants', 'service_role', 'UPDATE'),
      ('matches', 'authenticated', 'SELECT'),
      ('matches', 'service_role', 'DELETE'),
      ('matches', 'service_role', 'INSERT'),
      ('matches', 'service_role', 'SELECT'),
      ('matches', 'service_role', 'UPDATE'),
      ('messages', 'authenticated', 'SELECT'),
      ('messages', 'service_role', 'DELETE'),
      ('messages', 'service_role', 'INSERT'),
      ('messages', 'service_role', 'SELECT'),
      ('messages', 'service_role', 'UPDATE'),
      ('notification_settings', 'authenticated', 'SELECT'),
      ('notification_settings', 'service_role', 'DELETE'),
      ('notification_settings', 'service_role', 'INSERT'),
      ('notification_settings', 'service_role', 'SELECT'),
      ('notification_settings', 'service_role', 'UPDATE'),
      ('poll_votes', 'service_role', 'DELETE'),
      ('poll_votes', 'service_role', 'INSERT'),
      ('poll_votes', 'service_role', 'SELECT'),
      ('poll_votes', 'service_role', 'UPDATE'),
      ('polls', 'service_role', 'DELETE'),
      ('polls', 'service_role', 'INSERT'),
      ('polls', 'service_role', 'SELECT'),
      ('polls', 'service_role', 'UPDATE'),
      ...
      ('profile_vectors', 'service_role', 'DELETE'),
      ('profile_vectors', 'service_role', 'INSERT'),
      ('profile_vectors', 'service_role', 'SELECT'),
      ('profile_vectors', 'service_role', 'UPDATE'),
      ...
      ('push_tokens', 'service_role', 'DELETE'),
      ('push_tokens', 'service_role', 'INSERT'),
      ('push_tokens', 'service_role', 'SELECT'),
      ('push_tokens', 'service_role', 'UPDATE'),
      ('region_group_settings', 'authenticated', 'SELECT'),
      ('region_group_settings', 'service_role', 'DELETE'),
      ('region_group_settings', 'service_role', 'INSERT'),
      ('region_group_settings', 'service_role', 'SELECT'),
      ('region_group_settings', 'service_role', 'UPDATE'),
