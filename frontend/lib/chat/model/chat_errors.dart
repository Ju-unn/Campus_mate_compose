...
const String _trustAlreadyAnswered = '이미 수락했어요';
...
/// 수락을 두 번 보냈다. **이미 수락돼 있으면 원하던 결과가 이미 났다** —
/// 오류로 띄우면 수락해 놓고 실패한 것처럼 보인다.
bool isTrustAlreadyAnswered(Failure failure) =>
    failure.toDisplayMessage() == _trustAlreadyAnswered;
